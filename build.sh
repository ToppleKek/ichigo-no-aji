...
CXX_FILES_ENGINE="main.cpp util.cpp entity.cpp camera.cpp asset.cpp mixer.cpp editor.cpp"
CXX_FILES_GAME="game/ichiaji_main.cpp game/irisu.cpp game/coin.cpp"
...
LIBS_WIN32="user32 -lwinmm -ldsound -ldxguid -lxinput"
LIBS_LINUX="GL -lSDL2"
EXE_NAME="game.exe"
